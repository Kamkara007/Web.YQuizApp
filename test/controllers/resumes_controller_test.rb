...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference("Resume.count") do
      post resumes_url, params: { resume: { course_id: @resume.course_id, slug: @resume.slug, title: @resume.title, user_id: @resume.user_id } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { course_id: @resume.course_id, slug: @resume.slug, title: @resume.title, user_id: @resume.user_id } }
